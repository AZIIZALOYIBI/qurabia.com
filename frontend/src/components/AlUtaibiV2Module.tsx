...
export const AlUtaibiV2Module: React.FC = () => {
  ...
  return (
    <div className="p-6 bg-transparent h-full flex flex-col relative overflow-hidden" role="region" aria-label="معادلة العتيبي الموحدة v2.0">
      <div className="absolute top-0 right-0 w-64 h-64 bg-purple-500/5 rounded-full blur-3xl -mr-20 -mt-20 pointer-events-none" aria-hidden="true" />
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 flex-grow z-10">
        <div className="space-y-4">
          <div className="bg-black/40 p-4 rounded-lg border border-white/5">
            <label htmlFor="utaibi-radius" className="block text-xs font-mono text-slate-400 uppercase tracking-wider mb-2">
          ...
          <div className="bg-black/40 p-4 rounded-lg border border-white/5">
            <label htmlFor="utaibi-rhodm" className="block text-xs font-mono text-slate-400 uppercase tracking-wider mb-2">
          ...
          <div className="bg-black/40 p-4 rounded-lg border border-white/5">
            <label htmlFor="utaibi-rhode" className="block text-xs font-mono text-slate-400 uppercase tracking-wider mb-2">
        ...
        <div className="bg-black/60 rounded-lg border border-white/10 p-4 font-mono text-sm overflow-auto" aria-live="polite">
